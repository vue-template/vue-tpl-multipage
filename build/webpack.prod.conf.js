  ...
  plugins: [
    ...
    new webpack.optimize.CommonsChunkPlugin({
      ...
      minChunks: function (module, count) {
        // 公用 node 模块
        var nodeModules = /\.js$/.test(module.resource) &&
        ...
        var ui = /main\.(styl|scss|css)$/.test(module.resource)

        // any required modules inside node_modules are extracted to vendor
        return module.resource && (nodeModules || ui)
      }
    }),
    ...
    new CopyWebpackPlugin([{
      ...
      to: baseWebpackConfig.output.path
    }])
  ]
})
