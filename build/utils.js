var path = require('path') // node 原生 path 模块
var glob = require('glob') // glob 模块，用于读取 webpack 入口目录文件
...
exports.getEntries = function(globPath) {
  ...
  glob.sync(globPath).forEach(function(entry) {
    ...
    // var basename = path.basename(entry, path.extname(entry), 'router.js') // 过滤 router.js
